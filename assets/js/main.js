...
$(document).ready(function () {
  ...
  const menuData = {
    "Development Courses": [
      { title: "Frontend Web Development", url: "FrontendWebDevelopment.html", image: "https://upload.wikimedia.org/wikipedia/commons/6/61/HTML5_logo_and_wordmark.svg" },
      { title: "Advanced Frontend with Modern UI Frameworks", url: "AdvancedFrontendDevelopment.html", image: "https://upload.wikimedia.org/wikipedia/commons/3/3d/CSS.3.svg" },
      { title: "Backend Development with Python (Django)", url: "BackendDevelopmentwithDjango.html", image: "https://upload.wikimedia.org/wikipedia/commons/c/c3/Python-logo-notext.svg" },
      { title: "Backend Development with PHP, MySQL & Laravel", url: "BackendDevelopmentWithPHP.html", image: "https://upload.wikimedia.org/wikipedia/commons/2/27/PHP-logo.svg" }
    ],

    "Mobile Development": [
      { title: "Android App Development", url: "AndroidAppDevelopment.html", image: "https://upload.wikimedia.org/wikipedia/commons/d/d7/Android_robot.svg" },
      { title: "iOS App Development with Swift", url: "iOS-App-Development-with-Swift.html", image: "https://upload.wikimedia.org/wikipedia/commons/f/fa/Apple_logo_black.svg" },
      { title: "React Native App Development", url: "React-Native-App-Development.html", image: "https://upload.wikimedia.org/wikipedia/commons/a/a7/React-icon.svg" },
      { title: "Flutter App Development", url: "Flutter-App-Development.html", image: "https://upload.wikimedia.org/wikipedia/commons/1/17/Google-flutter-logo.png" }
    ],

    "Tech Specializations": [
      { title: ".NET Core & ASP.NET MVC Development", url: "dotnet-aspnet-mvc-development.html", image: "https://upload.wikimedia.org/wikipedia/commons/0/0e/Microsoft_.NET_logo.png" },
      { title: "WordPress Training with Job Placement", url: "WordPress-Training-with-Job-Placement.html", image: "https://upload.wikimedia.org/wikipedia/commons/2/20/WordPress_logo.svg" },
      { title: "Node.js Backend Development", url: "Node.js-Backend-Development.html", image: "https://upload.wikimedia.org/wikipedia/commons/d/d9/Node.js_logo.svg" },
      { title: "Django Web Development", url: "Django-Web-Development.html", image: "https://upload.wikimedia.org/wikipedia/commons/7/75/Django_logo.svg" },
      { title: "Angular Development Training", url: "Angular-Development-Training.html", image: "https://upload.wikimedia.org/wikipedia/commons/c/cf/Angular_full_color_logo.svg" }
    ],

    "Data & AI": [
      { title: "Machine Learning with Python", url: "Machine-Learning-with-Python.html", image: "https://www.svgrepo.com/show/235196/oculus-rift-virtual-reality.svg" },
      { title: "Data Analytics Fundamentals", url: "Data-Analytics-Fundamentals.html", image: "https://www.svgrepo.com/show/509028/bar-chart.svg" },
      { title: "Artificial Intelligence Basics", url: "Artificial-Intelligence-Basics.html", image: "https://www.svgrepo.com/show/486520/ai.svg" },
      { title: "Data Science Complete Course", url: "Data-Science-Complete-Course.html", image: "https://www.svgrepo.com/show/305933/datacamp.svg" },
      { title: "Data Visualization Techniques", url: "Data-Visualization-Techniques.html", image: "https://www.svgrepo.com/show/530261/pie-chart.svg" }
    ],

    "Networking & Security": [
        { title: "Linux Course", url: "Linux-Course.html", image: "https://www.svgrepo.com/show/373276/linux.svg" },
        { title: "Cloud Computing Course", url: "Cloud-Computing-Course.html", image: "https://www.svgrepo.com/show/530524/cloud.svg" },
        { title: "Ethical Hacking Course", url: "Ethical-Hacking-Course.html", image: "https://www.svgrepo.com/show/493162/hacker.svg" },
        { title: "Cyber Security", url: "Cyber-Security.html", image: "https://www.svgrepo.com/show/354361/snyk.svg" },
      { title: "Internet of Things (IoT) ", url: "Internet-of-Things-(IoT).html", image: "https://www.svgrepo.com/show/340470/iot-platform.svg" }
    ],

    "Programming Courses": [
      { title: "Python Programming Certification", url: "Python-Programming-Certification.html", image: "https://upload.wikimedia.org/wikipedia/commons/c/c3/Python-logo-notext.svg" },
      { title: "Java Programming Masterclass", url: "Java-Programming-Masterclass.html", image: "https://upload.wikimedia.org/wikipedia/en/3/30/Java_programming_language_logo.svg" },
      { title: "PHP Programming Course", url: "PHP-Programming-Course.html", image: "https://upload.wikimedia.org/wikipedia/commons/2/27/PHP-logo.svg" },
      { title: "C & C++ Programming Basics", url: "C-&-Cpp-Programming-Basics.html", image: "https://upload.wikimedia.org/wikipedia/commons/1/18/C_Programming_Language.svg" }
    ],

    "Internships": [
      { title: "15-Day Internship", url: "15-days-Internship.html" },
      { title: "45-Day Internship", url: "45-days-Internship.html" },
      { title: "84-Day Internship", url: "84-days-Internship.html" },
      { title: "6-Month Internship", url: "6-Month-Internship.html" }
    ]
  ...
  const dropdownItem = document.querySelector('.has-child-menu');
  const servicesLink = document.querySelector('.services-toggle');

  // Render submenu based on category
  function renderMenu(category, titleEl) {
    document.querySelectorAll('.menu-title').forEach(t => t.classList.remove('active'));
    if (titleEl) titleEl.classList.add('active');

    submenuContent.innerHTML = '';

    const isImageCategory = menuData[category].some(item => item.image);
    submenuContent.style.columns = isImageCategory ? 'unset' : '2';
    submenuContent.style.display = isImageCategory ? 'grid' : 'block';
    submenuContent.style.gridTemplateColumns = isImageCategory ? 'repeat(2, 1fr)' : '';
    submenuContent.style.gap = isImageCategory ? '15px 30px' : '';

    menuData[category].forEach(course => {
      ...
      link.addEventListener('click', (e) => {
        // Optional for mobile: close menu
  ...
  Object.keys(menuData).forEach((category, index) => {
    ...
    title.addEventListener('click', (e) => {
      e.stopPropagation();
      renderMenu(category, title);
    });

    menuLeft.appendChild(title);

    if (index === 0) renderMenu(category, title);
  });
  ...
  servicesLink.addEventListener('click', function (e) {
    ...
    if (isMobile) {
      ...
      // Toggle on desktop too (click instead of hover)
      dropdownItem.classList.toggle('show');
    }
  });

  // Close mega menu when clicking outside (only mobile)
  document.addEventListener('click', function (e) {
    const isMobile = window.innerWidth <= 991;
    if (isMobile && !e.target.closest('.has-child-menu')) {
      dropdownItem.classList.remove('show');
    }
  });
});
